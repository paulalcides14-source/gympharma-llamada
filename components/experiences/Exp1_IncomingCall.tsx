...
export default function Exp1_IncomingCall({ onNext }: Props) {
  ...
  useEffect(() => {
    if (callStatus === "incoming") {
      const interval = setInterval(() => {
        ...
        // iPhone style ringtone chords
        playTone(440, "sine", 0.5, 0.2); // A4
        setTimeout(() => playTone(554.37, "sine", 0.4, 0.2), 200); // C#5
        setTimeout(() => playTone(659.25, "sine", 0.5, 0.2), 400); // E5
      }, 2000);
  ...
  const handleReject = () => {
    ...
    // If active, do nothing to enforce listening to the full audio as requested
  };
      ...
      {callStatus !== "ended" && (
        ...
        >
          ...
          <div 
            ...
            style={{ backgroundImage: "url('/call_bg_pullup.png')" }}
          />

          {/* Top content: "Gympharma" & Timer */}
          <div className="flex flex-col items-center mt-12 z-10 w-full relative">
            <h1 className="text-5xl font-bold tracking-wide text-white drop-shadow-md pb-2">
              Gympharma
            </h1>
              ...
              <>
                ...
                <div className="flex flex-col items-center gap-3">
                  <div className="relative">
                    ...
                    >
                      <Phone size={34} fill="currentColor" className="animate-pulse" />
                    </button>
                  </div>
            ...
            {callStatus === "active" && (
              <div className="flex flex-col w-full px-6 mb-4">
                ...
                <div className="flex justify-center w-full">
                  <button
                    onClick={handleReject}
                    className="w-[72px] h-[72px] rounded-full bg-red-500/90 flex items-center justify-center hover:bg-red-500 transition-all active:scale-95 shadow-lg shadow-red-500/30 backdrop-blur-sm"
                  >
